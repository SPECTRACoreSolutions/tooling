...
class SPECTRAControlCenter:
    ...
    def temp_monitor(self):
        ...
        os.system("start python cpu-temp-rgb.py")
    ...
    def show_help(self):
        ...
        print("  python rgb-control.py work      # Quick work mode")
        print("  python rgb-control.py gaming    # Quick gaming mode")
        print("  python rgb-control.py off       # Quick off\n")

        print("Scripts:")
        print("  control-center.py   - This interactive menu")
        print("  rgb-control.py      - Command-line control")
        print("  cpu-temp-rgb.py     - Temperature monitor\n")
