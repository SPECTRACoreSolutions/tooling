...
# Source location (script lives in toolkit, so use script root)
$coreToolkit = if ($PSScriptRoot) { $PSScriptRoot } else { "C:\Users\markm\OneDrive\SPECTRA\Core\tooling\pc-build-toolkit" }
...
if ($USBDrive -eq "") {
    ...
    if ($usbDrives.Count -eq 1) {
        ...
        $usbDrives | ForEach-Object {
            ...
            Write-Host "   $($_.DriveLetter): - $($_.FileSystemLabel) ($sizeGB GB total)"
        }
        $USBDrive = Read-Host "Enter drive letter (e.g. E)"
...
Write-Host "   1. Core toolkit (everything) to USB" -ForegroundColor Cyan
...
# ===========================================================================
# SYNC: CORE TOOLKIT TO USB
# ===========================================================================

Write-Host "===========================================================================" -ForegroundColor Cyan
Write-Host "1. Syncing Documentation and Scripts (Core to USB)" -ForegroundColor Yellow
Write-Host "===========================================================================`n" -ForegroundColor Cyan
...
$docFiles = @(
    ...
    ".gitignore",
    "POST-WIPE-INSTALL-EVERYTHING.md",
    "INSTALLED-APPS-SCAN.md",
    "BIOS-SETTINGS-CHECK.md",
    "BIOS-POST-WIPE-GUIDE.md",
    "BUILD-DAY-QUICK-START.md",
    "CURRENT-HARDWARE.md",
    "RAM-UPGRADE-RECOMMENDATION.md"
)
...
if (Test-Path "$coreToolkit\05-Scripts") {
    ...
    Write-Host "   [OK] 05-Scripts/" -ForegroundColor Green
}
...
if (Test-Path "$coreToolkit\06-Documentation") {
    ...
    Write-Host "   [OK] 06-Documentation/" -ForegroundColor Green
}
...
if (Test-Path $downloadScript) {
    ...
    Write-Host "   [OK] download-toolkit.ps1" -ForegroundColor Green
}
...
if (Test-Path $syncScript) {
    ...
    Write-Host "   [OK] sync-to-usb.ps1`n" -ForegroundColor Green
}

# ===========================================================================
# SYNC: ALL CORE CONTENT TO USB
# ===========================================================================

Write-Host "===========================================================================" -ForegroundColor Cyan
Write-Host "2. Syncing All Content (Core to USB)" -ForegroundColor Yellow
Write-Host "===========================================================================`n" -ForegroundColor Cyan
...
Write-Host "   2. Run this script to sync Core to USB" -ForegroundColor White
